...
- Updated documentation generation workflow
  ...
  - Added restrictions on automatic building to the following
    ...
    - PRs that target `main` or `develop/v*` with changes to `Documentation~`, `.github/workflows` or `WebsiteDocs~` (no deployment)
  ...
  - Updated workflow to have better naming and error reporting
